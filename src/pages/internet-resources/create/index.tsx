...
import { createInternetResource } from 'apiSdk/internet-resources';
...
function InternetResourceCreatePage() {
  ...
  const handleSubmit = async (values: InternetResourceInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createInternetResource(values);
      resetForm();
