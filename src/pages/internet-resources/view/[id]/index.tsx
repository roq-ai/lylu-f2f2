...
import { getInternetResourceById } from 'apiSdk/internet-resources';
...
function InternetResourceViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Internet Resource Detail View
          </Text>
          {hasAccess('internet_resource', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/internet-resources/edit/${data?.id}`} passHref legacyBehavior>
              <Button
